...
class viewJurVipnet1 extends Jurnals {
...
//
    ...
    public function MainContent()
  {
        ...
        print "<script language='javascript'>var opti='viewJurVipnet1' </script>";
...
echo '<li><a href="#tabr1">Запросы обработанные</a></li>
        ...
        echo $this->UIButtonAjax('Create', 'Тестовая Форма');
...
//            }
    ...
    public function Create($Caption, $data) {
        $m=$this->FormsUI();
        //$m.LabelText('ВНИМАНИЕ ПРЕЖДЕ ЧЕМ НАЖАТЬ КНОПКУ положите ОТПРАВЛЯЕМЫЕ файлы по пути '.PathVremFiles.' Затем открывайте это ОКНО. Если положить файлы когда окно открыто ФАЙЛЫ не ПОДПИШУТЬСЯ');
//        Echo "<Div class=grid>"; 
