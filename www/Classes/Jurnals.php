...
//              "IdUserCreate"=>"Сотрудник, принявший заявление");
   ...
   $arrays = array(
    ...
    public function MainContent(){
        ...
        echo '<p><a href="?option=viewJurVipnet1"><H6> Журнал регистрации направления поступления и исполнения запросов (Распоряжение Правления ПФР 463Р от 06.10.2015)</H6></a></p>';
